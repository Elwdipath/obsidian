...
- If 2 indexes are not out of order, do nothing and move to the next iteration
- If they are out of order, swap places
- Outer loop of function will check if anything swapped. If indexes were swap, start again.
